...
- (void)viewDidLoad
{
    ...
    NSLog (@"%@, arr 1 is %@",JsonObject, _jsonArray);   	NSDictionary *dic1 = (NSDictionary *)[_jsonArray objectAtIndex:0];
...
-(void) insertData{
    ...
    NSString *insertSql1= [NSString stringWithFormat:
						   @"INSERT INTO '%@' ('%@', '%@', '%@', '%@', '%@', '%@', '%@') VALUES ('%@', '%@', '%@', '%@', '%@', '%@', '%@')",
						   TABLENAME, PID, NAME, DESCRIPTION, REGULAR_PRICE, SALE_PRICE, COLORS, STORES, @"1001", @"product1", @"this", @"1.1", @"1.2", strColors, strStores];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    NSDictionary *dic = [_jsonArray objectAtIndex:indexPath.row];
