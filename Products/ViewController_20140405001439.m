...
-(void) insertData{
    ...
    NSString *insertSql1= [NSString stringWithFormat:
						   @"INSERT INTO '%@' ('%@', '%@', '%@', '%@', '%@', '%@', '%@') VALUES ('%@', '%@', '%@', '%@', '%@', '%@', '%@')",
						   TABLENAME, PID, NAME, DESCRIPTION, REGULAR_PRICE, SALE_PRICE, COLORS, STORES, [dic1 objectForKey:@"id"], [dic1 objectForKey:@"name"], [dic1 objectForKey:@"description"], [dic1 objectForKey:@"regular price"], [dic1 objectForKey:@"sale price"], strColors, strStores];
